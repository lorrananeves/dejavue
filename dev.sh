...
GREEN='\033[00;32m'
YELLOW='\e[0;33m'
HOST_PROD=mytodolist.example.com
...
workon mytodolist  # Change this to your project's name
...
function dknpminstall {
    CD=$(pwd)
    cd $PROJ_BASE
    docker run -it --rm -v $(pwd):/app -w /app/frontend -e NODE_ENV=development mytodolist npm install
    exitcode=$?
    cd $CD
    return $exitcode
}
...
function dkrun_prod {
    ...
    docker run --name mytodolist -d --env-file /home/ubuntu/mytodolist.env \
        -p 3000:3000 -p 8000:8000 \
        -v /home/ubuntu/dkdata/mytodolist:/dkdata \
        mytodolist start_web.sh
}
...
echo_green "Welcome to mytodolist's dev env"
